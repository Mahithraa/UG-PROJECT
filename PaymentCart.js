...
const PaymentCart = (props) => {
    ...
    cart.shippingPrice = twoDecimalsNumber(cart.itemsPrice > 200 ? 50 : 25);
    ...
    const totalAmount = cart.totalPrice.toFixed(2);
    return (
        <>
            <Menu />
                    ...
                    <div className="row">
                        <div className="col-sm-8">
                            {
                                ...
                                cartItems && cartItems.map((item) => (
                                    <div className="row_loop" key={item.product}>
                                        ...
                                        <div className="colcart">
                                            <h6>Price: {(item.price * item.quantity).toFixed(2)}</h6>
                                        </div>
                        ...
                        <div className="col-sm-4">
                            <div className="shipping_details text-center pt-3">
                                <h4>Shipping</h4>
                                <div className=""><b>Name:</b> {shippingAddress.fullName}</div>
      ...
      <QRCode value={`upi://pay?pa=mahithraa29-1@okaxis&pn=Mahithraa&mc=1234&tid=CUST1234tn=${totalAmount}&am=${totalAmount}&cu=INR`} size={100} />
    </div>
