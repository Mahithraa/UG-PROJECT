            ...
            <div className="position-sticky">
                <div className="list-group list-group-flush mx-3 mt-4">
                    ...
                    <Link to="/admin/dashboard/orders" className="list-group-item list-group-item-action py-2 ripple"><i
                        className="fas fa-chart-bar fa-fw me-3"></i><span>Orders</span>
                    </Link>

                    <Link to="/admin/users" className="list-group-item list-group-item-action py-2 ripple"><i
                        className="fas fa-users fa-fw me-3"></i><span>Users</span>
                    </Link>

                    <Link to="/admin/users" className="list-group-item list-group-item-action py-2 ripple"><i
                        className="fas fa-chart-bar fa-fw me-3"></i><span>Analytics</span>
                    </Link>
