      ...
      <div className="container fullheight wrapper_add_to_Cart" >
        ...
        <div className="row">
          <div className="col-sm-9">
            {
              cartItems < 1 ? <><h2 style={{ color: "#0e6098", fontFamily: "Cinzel Decorative", fontVariantCaps:"all-petite-caps"}}>Your cart is empty!</h2></> :
                cartItems.map((item) => (
          ...
          <div className="col-sm-3">
            <div className="order_sumary" style={{ fontFamily: "Cinzel Decorative" }}>
