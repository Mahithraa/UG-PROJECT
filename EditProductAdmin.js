...
const EditProductAdmin = ({ match, history }) => {
        ...
        axios.get(`/api/product/${match.params.id}`)
            .then((prod) => {
                ...
                if (prod) {
                    ...
                    setSeller(prod.data.product.seller);
    ...
    const handleSubmit = (e) => {
        ...
        axios.put(`/api/product/edit/${match.params.id}`, { name, description, price, avatar, category, seller ,countStock })
        ...
        <>
            <div className="container custom_class">
                ...
                <form className=" col-sm-6 offset-3 pt-5 signup_form " enctype="multipart/form-data">
                    ...
                    <div className="form-outline mb-4">
                        <input onChange={(e) => setSeller(e.target.value)} type="text" id="form4Example3" className="form-control" />
                        <label className="form-label" htmlFor="form4Example2">Seller </label>
                    </div>
